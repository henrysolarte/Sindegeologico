...
export default function Hero() {
  ...
  return (
    <section id="hero" className="hero section py-5" style={{ backgroundColor: '#e3f3f0', minHeight: '80vh', display: 'flex', alignItems: 'center' }}>
          ...
          <div className="col-lg-6">
            <div className="content">
              ...
              <div className="cta-group d-flex flex-wrap align-items-center gap-4 mt-4">
                <a href="#register" className="btn text-white px-4 py-2" style={{ backgroundColor: '#069169', borderColor: '#069169', fontWeight: '500' }}>
                  Start Your Journey
                </a>
                <a 
